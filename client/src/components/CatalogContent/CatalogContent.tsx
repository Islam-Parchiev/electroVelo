...
const CatalogContent:React.FC = () => {
	const {data} = useQuery<{data:ICard[]}>({ queryKey: ['catalogProducts'], queryFn:()=> productService.getProductsByLimit(9,3)  })
	console.log(data);
	return (
				...
				<div className={styles.CatalogContent__wrapper}>
					...
					<div className={styles.CatalogContent__right}>
						...
						<div className={styles.Pagination}>
							<button
								className={`btn-reset ${styles.Pagination__first}`}>
								<svg
							...
							<button
								...
								<svg xmlns="http://www.w3.org/2000/svg" width="10" height="18" viewBox="0 0 10 18" fill="none">
									<path d="M3.482 2.17495L9.49986 8.47495C9.57129 8.54995 9.62177 8.6312 9.65129 8.7187C9.68129
									 ...
									 1.98745 2.61891 1.8937 2.857 1.8937C3.0951 1.8937 3.30343 1.98745 3.482 2.17495Z" fill="#777777"/>
								</svg>
							</button>
							<button
								className={`btn-reset ${styles.Pagination__last}`}>
								<svg xmlns="http://www.w3.org/2000/svg" width="10" height="18" viewBox="0 0 10 18" fill="none">
									<path d="M3.482 2.17495L9.49986 8.47495C9.57129 8.54995 9.62177 8.6312 9.65129 8.7187C9.68129
									 8.8062 9.69629 8.89995 9.69629 8.99995C9.69629 9.09995 9.68129 9.1937 9.65129 9.2812C9.62177 
									 9.3687 9.57129 9.44995 9.49986 9.52495L3.482 15.8437C3.31534 16.0187 3.107 16.1062 2.857 
