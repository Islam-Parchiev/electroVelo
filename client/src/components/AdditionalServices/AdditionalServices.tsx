				...
				<div className={styles.AdditionalServices__inner}>
					...
					<div className={styles.AdditionalServices__content}>
						<ContactsAccordion accordionTitle="Ремонт привода">
							<ul
								className={`list-reset ${styles.AdditionalServices__list}`}>
								<li className={styles.AdditionalServices__item}>
									<span
										className={
											styles.AdditionalServices__item_title
										}>
										Укорачивание штока вилки
									</span>
									<span
										className={
											styles.AdditionalServices__item_price
										}>
										600 ₽
									</span>
								</li>
