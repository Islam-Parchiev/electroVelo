		...
		<section className={styles.DeliveryInfo}>
			<div className="container">
				<div className={styles.DeliveryInfo__inner}>
					<h2 className={styles.DeliveryInfo__title}>Информация о доставке</h2>
					<div className={styles.DeliveryInfo__text}>
						<p>
							Для удобства покупателей действует несколько способов доставки товаров.
							 Существует доставка по Москве и М.О., доставка по регионам России и самовывоз.
						...
						<span>На любые вопросы по правилам и стоимости доставки ответят оператор: <a href="/">+7(495)055-75-86</a></span>
					</div>
					<div className={styles.DeliveryInfo__content}>
						<ContactsAccordion accordionTitle="Доставка по Москве, в пределах МКАД">
							<div className={styles.DeliveryInfo__accordion}>
								<span>Заказы стоимостью до 20 тыс. ₽ — 1 000 ₽</span>
								<span>Заказы стоимостью более 20 тыс. ₽ — Бесплатно.</span>
								<span>Доставка негабаритных товаров рассчитывается отдельно.</span>
								<span>Срок доставки не более 2 дней с момента согласования заказа. При доставке по Москве оплату товара можно произвести курьеру.</span>
							</div>
						</ContactsAccordion>
