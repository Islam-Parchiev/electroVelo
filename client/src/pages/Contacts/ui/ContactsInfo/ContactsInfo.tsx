				...
				<div className={styles.ContactsInfo__inner}>
					<div className={styles.ContactsInfo__left}>
						<div className={styles.ContactsInfo__block}>
							...
							<ul
								className={`list-reset ${styles.ContactsInfo__block_list}`}>
						...
						<div className={styles.ContactsInfo__block}>
							...
							<ul
								className={`list-reset ${styles.ContactsInfo__block_list}`}>
								<li className={styles.ContactsInfo__block_item}>
									Понедельник — Воскресение с 10:00 до 20:00
									часа
								</li>
								<li className={styles.ContactsInfo__block_item}>
									БЕЗ ВЫХОДНЫХ
						...
						<div className={styles.ContactsInfo__block}>
							...
							<ul
								className={`list-reset ${styles.ContactsInfo__block_list}`}>
								<li className={styles.ContactsInfo__block_item}>
									<a href="/">+7 (495) 055756756</a>
								</li>
								<li className={styles.ContactsInfo__block_item}>
									<a href="/">+7 (495) 055776765</a>
								</li>
							</ul>
						</div>
						<div className={styles.ContactsInfo__block}>
							...
							<ul
								className={`list-reset ${styles.ContactsInfo__block_list}`}>
								<li className={styles.ContactsInfo__block_item}>
									<a href="/">order@world-bike.ru — заказы</a>
								</li>
								<li className={styles.ContactsInfo__block_item}>
									<a href="/">order@world-bike.ru — заказы</a>
								</li>
					...
					<div className={styles.ContactsInfo__right}>
						<div className={styles.ContactsInfo__block}>
							...
							<ul
								className={`list-reset ${styles.ContactsInfo__left_list}`}>
